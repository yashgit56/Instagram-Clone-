...
import ChagneProfilePhotoModal from './ChagneProfilePhotoModal';
...
const EditAccountDetails = () => {
    ...
    const [ imageFile, setImageFile ] = useState("https://cdn.pixabay.com/photo/2015/03/04/22/35/avatar-659651_1280.png") ;

    const [ initialValues, setInitialValues ] = useState({
        name:"", username:"" , email:"", bio:"", mobile:"",gender:"",website:"",private:false
    });
        ...
        <div className='flex pb-7'>
            <div className='w-[15%]'>
                <img 
                    ...
                    src={ imageFile || user.reqUser?.image || 
                ...
                <Stack spacing="6">
                    ...
                    <FormControl className='flex' id="username">
                        ...
                        <div className='w-full'>
                            ...
                            />
                            <FormHelperText className='text-xs'>
                                In most cases, you'll be able to change your username for 14 days. 
                                Learn More
                            </FormHelperText>
                        </div>
                    </FormControl>
                    <FormControl className='flex' id="website">
                        ...
                        <div className='w-full'>
                            ...
                            <FormHelperText className='text-xs'>
                                ...
                                Visit the Instagram app and edit your profile to change the websites in bio.
                            </FormHelperText>
                        </div>
                    </FormControl>
                    ...
                    <div className='py-10'>
                        ...
                        <p className='text-xs'> Provide your personal information. even if the account is used for a business,
